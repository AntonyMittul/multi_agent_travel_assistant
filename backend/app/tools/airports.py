...
AIRPORTS: Dict[str, Dict[str, Any]] = {
    ...
    "srinagar": {"iata": "SXR", "lat": 33.9871, "lon": 74.7742, "name": "Srinagar Intl"},
    "jaipur": {"iata": "JAI", "lat": 26.8242, "lon": 75.8122, "name": "Jaipur Intl"},
    "lucknow": {"iata": "LKO", "lat": 26.7606, "lon": 80.8893, "name": "Chaudhary Charan Singh Intl"},
    "ahmedabad": {"iata": "AMD", "lat": 23.0772, "lon": 72.6347, "name": "Sardar Vallabhbhai Patel Intl"},
    "pune": {"iata": "PNQ", "lat": 18.5793, "lon": 73.9089, "name": "Pune"},
    "varanasi": {"iata": "VNS", "lat": 25.4524, "lon": 82.8593, "name": "Lal Bahadur Shastri Intl"},
    "udaipur": {"iata": "UDR", "lat": 24.6177, "lon": 73.8961, "name": "Maharana Pratap"},
    "amritsar": {"iata": "ATQ", "lat": 31.7096, "lon": 74.7973, "name": "Sri Guru Ram Dass Jee Intl"},
    "leh": {"iata": "IXL", "lat": 34.1359, "lon": 77.5465, "name": "Kushok Bakula Rimpochee"},
    "guwahati": {"iata": "GAU", "lat": 26.1061, "lon": 91.5859, "name": "Lokpriya Gopinath Bordoloi Intl"},
