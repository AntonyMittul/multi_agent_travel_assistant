...
_INTAKE_PROMPT = (
    ...
    "AND the trip length (nights or dates). Origin city, budget (+currency), number of "
    "travelers and interests all make the plan better — ask for the most useful missing one.\n"
